...
### Blog Post Link ###
[Link](https://medium.com/institute-for-applied-computational-science/platepals-revolutionizing-nutritional-awareness-with-ai-5b4cc45d5d44)
...
To get a closer look at our model's training process, please take a look at our [Jupyter Notebook](https://github.com/amelialwx/AC215_PlatePals/blob/main/notebooks/model_training.ipynb). This notebook outlines the steps we took in preprocessing our images and training our model. For deployment, our model is compatible with Vertex AI for cloud-based applications and is also available for local deployment through our GitHub releases at [PlatePals Model Releases](https://github.com/amelialwx/PlatePals/releases).
