...
export DISPLAY_NAME="platepals_train_job_$UUID"
export MACHINE_TYPE="n1-standard-4"
export REPLICA_COUNT=1
export EXECUTOR_IMAGE_URI="us-docker.pkg.dev/vertex-ai/training/tf-gpu.2-12.py310:latest"
export PYTHON_PACKAGE_URI=$GCS_BUCKET_URI/platepals-trainer.tar.gz
...
export CMDARGS="--model_name=EfficientNetV2B0,--epochs=3,--batch_size=32,--wandb_key=$WANDB_KEY"
