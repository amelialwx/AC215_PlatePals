...
export DISPLAY_NAME="platepals_effnetv2b0_training_job_$UUID"
export MACHINE_TYPE="n1-standard-4"
export REPLICA_COUNT=1
export EXECUTOR_IMAGE_URI="us-docker.pkg.dev/vertex-ai/training/tf-gpu.2-12.py310:latest"
export PYTHON_PACKAGE_URI=$GCS_BUCKET_URI/platepals-effnetv2b0-trainer.tar.gz
export PYTHON_MODULE="effnetv2b0-trainer.task"
