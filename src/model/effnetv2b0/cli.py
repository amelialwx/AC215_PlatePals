...
DISPLAY_NAME = "platepals_effnetv2b0_training_job_" + job_id

TRAIN_IMAGE = "us-docker.pkg.dev/vertex-ai/training/tf-gpu.2-12.py310:latest"

job = aip.CustomPythonPackageTrainingJob(
    display_name=DISPLAY_NAME,
    python_package_gcs_uri=f"{GCS_BUCKET_URI}/platepals-effnetv2b0-trainer.tar.gz",
    python_module_name="effnetv2b0-trainer.task",
...
print(f"{GCS_BUCKET_URI}/platepals-effnetv2b0-trainer.tar.gz")
print(TRAIN_IMAGE)
